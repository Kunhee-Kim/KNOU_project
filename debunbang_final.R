...
# LR model 1_1
model1 <- glm(target ~ gravity + ph + cond + urea + calc, data = train_data, family = binomial)
...
# LR model 2_2
model2_2 <- glm(target ~ gravity + calc + ph * cond * urea, data = train_data, family = binomial)
